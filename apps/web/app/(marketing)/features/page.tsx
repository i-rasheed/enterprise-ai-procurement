...
const features = [
  ...
  { title: "Paystack billing", body: "Checkout, subscriptions, and webhook-driven plan sync." },
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 md:px-6">
      ...
      <p className="text-muted-foreground mt-2 max-w-2xl">
        SpendWise ships with the subscription, billing, and operations layer enterprises expect.
      </p>
